...
** is fixed at 0x27
**
** Written for and tested with Arduino 1.6.7
...
**       INT0 is on D2
** Wiring for Arduino Uno: A4->SDA, A5->SCL
*/
#include <Wire.h>
#include <LCD.h>
#include <LiquidCrystal_I2C.h>

// These pins are on the PCF8574 I/O expander for I2C-bus, not the Uno
...
// Switch on the backlight
  ...
  lcd.home ();                    // Home
  lcd.print("RF HOME AUTOMATION");  // Logo 1st line
  lcd.setCursor ( 0, 1 );         // Go to the 2rd line
  lcd.print("BY DENNIS MWANZA");
   lcd.setCursor ( 0, 2 );         // Go to the 3rd line
  lcd.print("PRESS THE  BUTTONS ");
  lcd.setCursor ( 0, 3 );         // Go to the 4rd line
